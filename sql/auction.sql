...
INSERT IGNORE INTO `auction`.`item` (`item_id`, `itemname`, `photo`, `description`, `initialprice`, `endtime`, `category_id`, `user_id`, `winner`) VALUES
(17, 'ipad2', '../../asset/itemImg/step0-ipad-gallery-image4.png', 'this is an ipad2, top rate tablet device of 2010 and 2011, ranking 4-5(full star) across top review website. Bid now start from just RM23.33 ringit!!!', 23.33, '2019-03-22 11:00', 12, 9, 7),
(18, 'imac', '../../asset/itemImg/imac.jpg', 'Imac, the one stop desktop for all ppl ranging from student to pro carrer worker, bid now start from RM100', 100, '2019-03-12 14:12', 12, 9, 5),
...
(30, 'tardis', '../../asset/itemImg/00iHy.jpg', 'TARDIS. Doctor Who. Serials. Little box outside, bigger inside. Ohohoh. Fantaastiic!', 50, '2019-03-10 00:05', 4, 7, 0);
...
--
ALTER TABLE `auction`.`bidHistory`
  -- MODIFY `bidhistory_id` AUTO_INCREMENT,
  AUTO_INCREMENT=80;
