...
(31, '???????', '../../asset/itemImg/bob.png', 'sddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddds', 322, '2019-04-30 21:11', 4, 7, 0),
(32, '???????', '../../asset/itemImg/bob.png', 'jkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjk', 322, '2019-05-02 10:45', 22, 5, 0),
(33, 'kek', '../../asset/itemImg/bob.png', 'fgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfgfg', 322, '2019-05-03 11:11', 22, 5, 0),
(34, '???????', '../../asset/itemImg/bob.png', 'dssssssssssssssssssdsssssssssssssssssdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsd', 322, '2019-05-02 19:53', 22, 1, 0),
(35, '???????', '../../asset/itemImg/bob.png', '????????????????????????????????????????????????????????????????????????????????????????', 322, '2019-05-02 19:29', 4, 1, 0),
(36, '???????', '../../asset/itemImg/bob.png', '????????????????????????????????????????????????????????????????????????????????', 322, '2019-05-02 21:32', 22, 1, 0),
(222, '111', '', '?????????????????????????????????????????????????????????????????????????????????????', 322, NULL, 0, 0, 0),
(222, '111', '', '?????????????????????????????????????????????????????????????????????????????????????', 322, NULL, 1, 0, 0),
(223, 'Джамиль', '../../asset/itemImg/bogomol33.jpg', 'вававававававававававававававававававававававававававававававававававававававава', 322, '2019-05-03 03:33', 22, 1, 0);
