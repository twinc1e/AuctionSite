<?php
	...
	if(isset($_POST["submit"])){
		...
		if(empty($error)){
			...
			$query = "INSERT INTO item(itemname, photo, description, initialprice, endtime, category_id, user_id) values('$name', '$photoURL', '$description', '$price', '$endtime', '$category', 1, $user)";
