<?php
	...
	if(isset($_GET['archive'])){
		...
		if($archive_id == 'all'){
			...
			$query = "SELECT * FROM item, category WHERE category.category_id = '$archive_id' AND item.category_id = '$archive_id' AND item.endtime >CURRENT_TIMESTAMP ORDER BY item.item_id DESC";
		}
...
?>
<!-- <script type="text/javascript" src="../../js/equalHeightCol.js"></script> -->
